...
public abstract class SerializableDictionary_Base
{
    protected class Dictionary<TKey, TValue> : System.Collections.Generic.Dictionary<TKey, TValue>
    {
        ...
        public Dictionary(SerializationInfo serialInfo, StreamingContext streamingContext) : base(serialInfo,
            streamingContext)
        {
        }
    }
...
/// </summary>
[Serializable]
public abstract class SerializableDictionary_Base<TKey, TValue, TValueCache> : SerializableDictionary_Base,
...
/// </summary>
[Serializable]
public class SerializableDictionary<TKey, TValue, TValueCache> : SerializableDictionary_Base<TKey, TValue, TValueCache>
    where TValueCache : SerializableDictionary.Cache<TValue>, new()
{
    ...
    protected SerializableDictionary(SerializationInfo serializationInfo, StreamingContext streamingContext) : base(
